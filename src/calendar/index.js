...
class Calendar extends Component {
  ...
  render() {
    ...
    return (
      ...
      >
        {/* <View
         style={[this.style.container, this.props.style,{backgroundColor:'white', height:ReactNative.Platform.isPad ?  verticalScale(430) : height < verticalScale(750) ?
          verticalScale(ReactNative.Platform.OS == 'ios' ? (height > 700) ? 350 : 420 : 410) : 
          verticalScale(ReactNative.Platform.OS == 'ios' ? (height > 700) ? 350 : 420 : 410),
          borderWidth: 1, borderColor:'#03B2D8'
        }]} */}
        <View
          style={[this.style.container, this.props.style, {
            backgroundColor: 'white', borderWidth: 1, borderColor: '#03B2D8',
            height: 'auto', paddingBottom: verticalScale(18)
          }]}
